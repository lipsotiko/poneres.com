      ...
      <IForm v-model="schema">
          ...
          <IRow>
            <IColumn>
              <div class="have-an-account">
                ...
                <p class="lead">
                  You may recieve a request for additional information via
                  email.
                </p>
        ...
        <div v-else class="form-container">
          ...
          <IRow>
            <IColumn xs="12">
              <IFormGroup required>
                <IFormLabel for="property"
                  >Which property are you applying for?</IFormLabel
                >
                <IInput
                  v-model="property"
                  id="property"
          ...
          <IRow>
            ...
            <IColumn xs="12" lg="3">
              <IFormGroup required>
                <IFormLabel for="lengthAtCurrentAddress"
                  >Length of time</IFormLabel
                >
                <IInput
          ...
          <IRow>
            <IColumn xs="12">
              <IFormGroup required>
                <IFormLabel for="reasonForLeaving"
                  >Reason for leaving?</IFormLabel
                >
                <ITextarea
                  id="reasonForLeaving"
          ...
          <IRow>
            ...
            <IColumn xs="12" lg="3">
              <IFormGroup required>
                <IFormLabel for="supervisorPhone"
                  >Supervisor contact</IFormLabel
                >
                <IInput
                  id="supervisorPhone"
          ...
          <IRow>
            <IColumn xs="12" lg="6">
              <IFormGroup required>
                <IFormLabel for="employerAddress"
                  >Employer's address</IFormLabel
                >
                <IInput
                  id="employerAddress"
            ...
            <IColumn xs="12" lg="3">
              <IFormGroup required>
                <IFormLabel for="employmentLength"
                  >Length of employment?</IFormLabel
                >
                <IInput
                  id="employmentLength"
          ...
          <IRow>
            ...
            <IColumn xs="12" lg="3">
              <IFormGroup required>
                <IFormLabel for="previousLandlordName"
                  >Landlord's name</IFormLabel
                >
                <IInput
            ...
            <IColumn xs="12" lg="2">
              <IFormGroup required>
                <IFormLabel for="previousLandlordPhone"
                  >Landlord's phone</IFormLabel
                >
                <IInput
            ...
            <IColumn xs="12" lg="2">
              <IFormGroup required>
                <IFormLabel for="lengthOfResidence"
                  >Length of recidence</IFormLabel
                >
                <IInput
          ...
          <IRow>
            <IColumn xs="12">
              <IFormGroup required>
                <IFormLabel for="reasonForMoving"
                  >Reason for moving?</IFormLabel
                >
                <ITextarea
                  id="reasonForMoving"
            ...
            <IColumn xs="12">
              <IFormGroup required>
                <IFormLabel for="references"
                  >Please list any personal references and their contact
                  information:
                </IFormLabel>
                <ITextarea
                  id="references"
          ...
          <IRow>
            <IColumn xs="12">
              <IFormGroup>
                <IFormLabel for="numberOfOccupants"
                  >How many people do you plan to have living in the
                  unit?</IFormLabel
                >
                <ITextarea
          ...
          <IRow>
            ...
            <IColumn xs="12" sm="4">
              <IFormGroup required>
                <IFormLabel for="haveYouBeenEvicted"
                  >Have you ever been evicted?</IFormLabel
                >
                <IRadioGroup
