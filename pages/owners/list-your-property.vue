<template>
  ...
  <IContainer>
    ...
    <div>
      <p class="lead">
        Before listing your property for sale, we will work with you to develop
        a unique marketing strategy aimed at selling your home quickly and for
        the highest possible price. You'll receive a comprehensive market
        analysis based on recently sold properties similar in features and
        condition to your home in the local area. This will help determine the
        optimal sale price, ensuring a quick sale while maximizing your profit.
      </p>
    </div>
    <ClientOnly>
